...
def _handle_eagle_family(server_args: "ServerArgs") -> None:
    ...
    # Spec v2 tree drafting supports topk > 1 with both page_size == 1 and
    # page_size > 1 (the latter via partial-page duplication; token-index
    # attention backends only -- see the backend guard below).
    spec_v1_reason = None
